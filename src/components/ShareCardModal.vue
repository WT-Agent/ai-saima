    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">赛马PK与矩阵决策</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 智能赛马 PK 与商业矩阵决策</span>
...
// 清理回复末尾的特殊标记 [SAIMA_SCORES]...[/SAIMA_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[SAIMA_SCORES\][\s\S]*?\[\/SAIMA_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 智能赛马PK与矩阵决策】\n\n${cleanContent.value}\n\n体验赛马PK商业决策助手：https://ai.wuxian.xyz`;
